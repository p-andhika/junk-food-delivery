...
👉 **Email & Password Auth**: User email address and password to login.
...
👉 **[WIP] Product Details Page**: Displays food images, key details, and allows adding items to the cart.  

👉 **Cart Page**: Review selected items and see the total price.  

👉 **[WIP] Profile Page**: Manage user settings and preferences.  
...
```bash
git clone https://github.com/p-andhika/junk-food-delivery.git
cd junk-food-delivery
```
